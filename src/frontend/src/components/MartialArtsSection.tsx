                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <button
                        ...
                        disabled={isLoggedIn && (actorFetching || completing)}
                        onClick={() => {
                          if (!isLoggedIn) {
                            onLoginClick();
                            return;
                        ...
                        style={{
                          ...
                          background:
                            isLoggedIn && (actorFetching || completing)
                              ? "oklch(0.18 0.02 295)"
                              : "linear-gradient(135deg, oklch(0.62 0.22 295) 0%, oklch(0.55 0.22 320) 100%)",
                          border: `1px solid ${isLoggedIn && (actorFetching || completing) ? "oklch(0.35 0.08 295 / 0.5)" : "oklch(0.72 0.22 295 / 0.6)"}`,
                          borderRadius: "6px",
                          color:
                            isLoggedIn && (actorFetching || completing)
                              ? "oklch(0.5 0.06 295)"
                        ...
                        onMouseEnter={(e) => {
                          if (isLoggedIn && (actorFetching || completing))
                            return;
